  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      social: {
        ...
        email: "mailto:trinath@ignitex.tech",
      },
    },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
            A team of passionate individuals dedicated to delivering exceptional
            results.
          </p>
        </motion.div>
