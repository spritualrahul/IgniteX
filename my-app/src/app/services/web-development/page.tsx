...
export default function WebsiteDevelopmentPage() {
        ...
        <div className="w-full h-28 bg-gray-50 border border-gray-100 rounded-t-lg p-2 overflow-hidden flex flex-col gap-1.5">
          ...
          <div className="flex justify-between items-center px-1">
            ...
            <div className="flex gap-1.5">
              <div className="w-4 h-1.5 bg-gray-200 rounded"></div>
              <div className="w-4 h-1.5 bg-gray-200 rounded"></div>
            </div>
          </div>
          <div className="flex flex-col items-center gap-1 mt-1 text-center">
            ...
            <div className="w-10 h-3 bg-red-500 rounded mt-1"></div>
          </div>
        </div>
      )
    },
      ...
      preview: (
        <div className="w-full h-28 bg-gray-50 border border-gray-100 rounded-t-lg p-2 overflow-hidden flex flex-col gap-1.5">
          ...
          <div className="flex gap-2">
            ...
            <div className="w-2/3 h-14 bg-gray-200 rounded flex items-center justify-center">
          ...
          <div className="grid grid-cols-3 gap-1 mt-0.5">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white border border-gray-100 rounded p-1 flex flex-col gap-1">
                <div className="w-full h-7 bg-gray-100 rounded"></div>
                <div className="w-3/4 h-1 bg-gray-200 rounded"></div>
                <div className="w-1/2 h-1 bg-emerald-500 rounded"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      preview: (
        <div className="w-full h-28 bg-gray-50 border border-gray-100 rounded-t-lg p-2 overflow-hidden flex flex-col gap-1.5">
          ...
          <div className="flex gap-1.5 flex-1">
            <div className="w-6 h-full bg-white border border-gray-100 rounded p-0.5 flex flex-col gap-1">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              <div className="flex justify-between gap-1">
                <div className="flex-1 h-3 bg-white border border-gray-100 rounded"></div>
                <div className="flex-1 h-3 bg-white border border-gray-100 rounded"></div>
              </div>
              <div className="w-full h-7 bg-white border border-gray-100 rounded p-1 flex items-end gap-0.5">
                ...
                <div className="w-1 h-2 bg-blue-300 rounded-t"></div>
  ...
  const designApproach = [
    {
      num: "01",
      title: "Discover",
      desc: "We understand your goals, audience, and business requirements.",
    ...
    },
    {
      num: "02",
      title: "Design",
      desc: "We create wireframes and stunning UI/UX designs tailored to your brand.",
    ...
    },
    {
      num: "03",
      title: "Develop",
      desc: "We build fast, secure, and responsive websites using modern technologies.",
    ...
    },
    {
      num: "04",
      title: "Launch",
      desc: "We test thoroughly and deploy your website for maximum performance.",
    ...
    },
    {
      num: "05",
      title: "Support",
      desc: "We provide ongoing support and optimization to help you grow.",
  ...
  const portfolio = [
    {
      title: "Luxora Interiors",
      category: "Business Website",
      image: "/images/projects/luxora_portfolio.png"
    },
    {
      title: "Glow & Co.",
      category: "E-Commerce Website",
      image: "/images/projects/glow_co_portfolio.png"
    },
    {
      title: "Taskly",
      category: "SaaS Website",
      image: "/images/projects/taskly_portfolio.png"
    },
    {
      title: "StartupHub",
      category: "Landing Page",
      image: "/images/projects/startuphub_portfolio.png"
    }
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#fcfdfd]">
        ...
        {/* Hero Section */}
        <section className="pt-36 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 relative flex justify-center">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-red-500/5 rounded-full blur-3xl -z-10"></div>
              
              {/* Device Mockup Graphic */}
              <div className="relative w-full max-w-[580px] p-2">
                <Image 
                  src="/images/projects/luxora_hero_mockup.png" 
                  alt="Luxora interiors responsive web design mockup" 
                  width={600} 
                  height={450} 
                  priority
                  className="object-contain w-full h-auto drop-shadow-xl rounded-lg"
                />
              </div>
            </div>
        ...
        {/* Solutions Section */}
        <section className="py-24 px-4 md:px-8 border-t border-gray-100 bg-white">
          <div className="max-w-7xl mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16">
              <span className="text-red-600 text-xs font-semibold uppercase tracking-[0.2em] mb-2 block">
                What We Design
              </span>
                ...
                <div key={index} className="group flex flex-col bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-xl hover:-translate-y-1 hover:border-gray-200 transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className={`w-8 h-8 rounded-lg ${sol.iconBg} flex items-center justify-center shrink-0`}>
                      <span className={`text-sm font-bold ${sol.iconColor}`}>
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />
                        </svg>
                      </span>
                    </div>
                    <h3 className={`text-base font-bold text-gray-900 ${sol.textColor} transition-colors`}>
                      {sol.title}
                    </h3>
                  </div>
                  ...
                  <Link 
                    href="/contact"
                    className={`inline-flex items-center gap-1 text-xs font-bold ${sol.iconColor} group-hover:gap-1.5 transition-all`}
                  >
        ...
        <section className="py-24 px-4 md:px-8 border-t border-gray-100 bg-[#fcfdfd]">
          <div className="max-w-7xl mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16">
        ...
        {/* Portfolio Section */}
        <section id="portfolio" className="py-24 px-4 md:px-8 border-t border-gray-100 bg-white">
          <div className="max-w-7xl mx-auto">
            {/* Portfolio Header */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
              ...
              <Link 
                href="/contact" 
                className="inline-flex items-center gap-1 text-sm font-bold text-gray-700 hover:text-red-600 transition-colors"
              >
        ...
        {/* Stats Section */}
        <section className="py-12 px-4 md:px-8 border-t border-b border-gray-100 bg-[#fcfdfd]">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="flex items-center gap-4 justify-center md:justify-start">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 font-medium uppercase tracking-[0.05em]">
                    {stat.label}
                  </div>
                </div>
              </div>
